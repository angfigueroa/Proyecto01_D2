...
// Función para configurar los pines de datos de la LCD
...
// Función para enviar comandos a la LCD
void Lcd_Cmd(char a) {
    RS = 0;
    Lcd_Port(a);
    EN = 1;
...
// Función para establecer la posición del cursor en la LCD
...
// Función para desplazar la pantalla hacia la derecha
void Lcd_Shift_Right() {
    Lcd_Cmd(0x01);
    Lcd_Cmd(0x0C);
}
// Función para desplazar la pantalla hacia la izquierda
void Lcd_Shift_Left() {
    Lcd_Cmd(0x01);
    Lcd_Cmd(0x08);
}